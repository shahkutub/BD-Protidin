...
public class SelectedRecyAdapter extends RecyclerView.Adapter<SelectedRecyAdapter.MyViewHolder> {
    Context context;
    ...
    public SelectedRecyAdapter(Context context, List<AllCommonNewsItem> latestList, OnItemClickListenerNews listener) {
